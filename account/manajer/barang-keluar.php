...
?>
 ...
 <?php
                      if(isset($_POST['save'])){
                        ...
                        if($keluar < 0){
                          $pesan= "Jumlah barang yang Anda masukkan melebihi stock yang ada.";
...
?>                      
                      <tr>
                        ...
                        <td><?php echo $d['sn'] ?></td>
                        <td><?php echo $d['jml_1'] ?></td>
                        <td>
                          <?php 
                          if($d['sts_kondisi']==1 ){
                            echo "<b> Barang Keluar </b>";
                          }
                          ?>
                        </td>
                        <td><?php echo $d['ket_1'] ?></td>
                      </tr>
<?php } ?>
                    </tbody>
                </table>
                  ...
                  <div class="modal-body" style="font-size: 9pt">
                    ...
                    <form method="post" action="">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_1" placeholder="Jumlah barang keluar" required>
                      </div>
                     
                     <div class="form-group">
                        <label>SN Barang :</label>
                        <input type="text" class="form-control" name="sn" placeholder="Masukan Serial Number Sparepat" required>          
                      </div>

                      <div class="form-group">
                        <label>Penjelasan Barang Keluar:</label>
                        <textarea type="text" id="editor" name="ket_1" ></textarea>          
                      </div>
