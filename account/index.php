...
include"../template/sidebar.php";
	...
	if(isset($_GET['p'])){
		...
		switch($page) {
			...
			case'item':include"manajer/barang-keluar.php";break;
			case'broken':include"manajer/rusak.php";break;
			case'pinjam':include"manajer/pinjam.php";break;
			case'perset':include"manajer/perset_pinjaman.php";break;
			case'r_pinjam':include"manajer/r_peminjaman.php";break;
			...
			case'pengajuan':include"user/pengajuan.php";break;
