      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php
          ...
          <?php }elseif($level == 3){ ?> <!----SARPRAS--->
              ...
              <li class="<?php if($_GET['p']=='item'){echo"active";} ?>"><a href="./item"><i class="fa fa-inbox"></i> <span> Barang Keluar </span></a></li>
              ...
              <li class="<?php if($_GET['p']=='pinjam'){echo"active";} ?>"><a href="./pinjam"><i class="fa fa-book"></i> <span> Peminjaman Barang</span></a></li>
              <li class="<?php if($_GET['p']=='r_pinjam'){echo"active";} ?>"><a href="./r_pinjam"><i class="fa fa-history"></i> <span> Riwayat Peminjaman</span></a></li>
              <!-- <li class="<?php //if($_GET['p']=='laporan'){echo"active";} ?>"><a href="./report"><i class="fa fa-line-chart"></i> <span>Laporan Inventaris</span></a></li> -->

          <?php }elseif($level == 6){ ?> <!-- User -->
              <li class="<?php if($_GET['p']=='pengajuan'){echo"active";} ?>"><a href="./pengajuan"><i class="fa fa-book"></i> <span> Peminjaman Barang</span></a></li>
